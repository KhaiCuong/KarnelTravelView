...
const TransportDetail = () => {
  ...
  const handleGetPageUpdate = (item) => {
    navigate(`/admin/transport/update/${item}`);
  };
  ...
  const handleDelete = (transport_id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        axios
          .delete(`http://localhost:5158/api/Transport/DeleteTransport/${transport_id}`)
          .then((s) => {
            navigate("/admin/transport");
          })
  ...
  return (
    <section>
      <h2 class="text-center font-weight-bold">{spot.transport_id}</h2>
      <div className="container-fluid">
        <ul class="list-group list-group-flush">
          <li class="list-group-item">
            <div class="row">
              <div class="col-3">Transport Id</div>
              <div class="col-9">{spot.transport_id}</div>
            </div>
          </li>
          <li class="list-group-item">
            <div class="row">
              <div class="col-3">Transport Name</div>
              <div class="col-9">{spot.transport_name}</div>
            </div>
          </li>
          <li class="list-group-item">
            <div class="row">
          ...
          <li class="list-group-item">
            <div class="row">
              ...
              <div class="col-9">{spot.status_Transport + ""}</div>
            </div>
          </li>
          <li class="list-group-item">
            <div class="row">
          ...
          <li class="list-group-item">
            <div class="row">
              <div class="col-3">Start Position</div>
              <div class="col-9">{spot.start_position}</div>
            </div>
          </li>
        </ul>
      </div>
      ...
      <div className="d-flex justify-content-around align-items-center mt-4">
        <div className="d-flex justify-content-between align-items-center w-50 mb-4">
          ...
          <button
            ...
            onClick={() => {
              handleGetPageUpdate(spot.transport_id);
            }}
          >
            Update
          </button>
