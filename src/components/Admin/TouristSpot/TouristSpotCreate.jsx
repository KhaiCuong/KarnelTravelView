      ...
      <>
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          <div className="mb-3 mt-3">
            ...
            <input type="text" className="form-control" placeholder="Enter Tour Id" id="touristSpot_id" name="touristSpot_id" onChange={handleChangeInput} />
          </div>
          <div className="mb-3 mt-3">
            <label for="touristSpot_name" className="form-label w-100">
              touristSpot_name
            </label>
            <input type="text" className="form-control" id="touristSpot_name" placeholder="Enter Tour Name" name="touristSpot_name" onChange={handleChangeInput} />
          </div>
          <div className="mb-3 mt-3">
            <label for="status_TouristSpot" className="form-label w-100">
              Status:
            </label>
            <input type="text" className="form-control" id="status_TouristSpot" placeholder="Enter Tour Status" name="status_TouristSpot" onChange={handleChangeInput} />
          </div>
          <div className="mb-3 mt-3">
          ...
          <div className="mb-3 mt-3">
            ...
            <input type="text" className="form-control" placeholder="Enter Tour description" id="activities" name="activities" onChange={handleChangeInput} />
          </div>
          <div className="mb-3 mt-3">
          ...
          <div className="mb-3 mt-3">
            ...
            <input type="text" className="form-control" placeholder="Enter Tour description" id="location_id" name="location_id" onChange={handleChangeInput} />
          </div>
