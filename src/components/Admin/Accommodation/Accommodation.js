...
import ListAccommodation from "./ListAccommodation"
    ...
    return (
        <section>
            <div id="wrapper" className="w-100">
                {/* <!-- Sidebar --> */}
                <ul
                    className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion d-flex"
                    id="accordionSidebar"
                >
                    {/* <!-- Sidebar - Brand --> */}
                    <a
                    ...
                    <ul className="sidebar-divider my-0">
                        ...
                        <ul className="sidebar-divider">
                            ...
                            <li className="nav-item">
                                ...
                                >
                                    <div className="bg-white py-2 collapse-inner rounded">
                                        ...
                                        <Link className="collapse-item" to="listAccommodation">
                                            List Accommodation
                                        </Link>
                                        <Link className="collapse-item" to="createAccommodation">
                            ...
                            <ul className="sidebar-divider">
                                ...
                                {/* <!-- Divider --> */}
                                <ul className="sidebar-divider d-none d-md-block">
