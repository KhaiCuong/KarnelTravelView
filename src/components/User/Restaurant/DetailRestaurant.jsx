...
import { getListRestaurantUser, getRestaurantByID, getRestaurantImageByID } from "./Service/ApiService";
...
function DetailofRestaurant() {
  ...
  return (
    <div className="main-view">
      ...
      <br />
      <div>
        <section className="ftco-section ftco-degree-bg" style={{ color: "background-color: rgba(0, 0, 0, 1)" }}>
          <div className="container text-light  bg-blur p-5" style={{ borderRadius: "13px" }}>
            ...
            <h2 className="text-light">
              {restaurant.restaurant_name} <i class="fas fa-utensils " style={{ fontSize: "24px" }}></i>{" "}
            </h2>

            <div className="star font-weight-bold text-light">
              <i class="fas fa-caret-right"></i> Restaurant {restaurant.rate} <i class="fa fa-star-o"></i>
            </div>
            <div className="star font-weight-bold text-light">
                    <i class="fas fa-caret-right"></i> Price: {restaurant.price} $
                  </div>
            <div className="star font-weight-bold text-light">
            ...
            <div class="product-box mb-5">
              ...
              <p class="round3  p-3 text-light border-white">{restaurant.description}</p>
            </div>

            {/* Booking */}
            <div className="borderwitdh col-md-12 hotel-single ftco-animate mb-5 mt-4 bg-light " style={{ borderRadius: "13px", borderColor: "white" }}>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="form-group position-relative">
                      ...
                      <input type="date" id="checkin_date" onChange={handleChangeDateIn} className="w-75 border-dark" placeholder="Date from" required />
                  ...
                  <div className="col-md-6">
                    <div className="form-group timess">
                      ...
                      <input type="time" id="appt-time" className="border-dark" name="appt" onChange={handleChangeDateOut} min="09:00" max="22:00" required></input>
                      {isSubmit && <span class="validity"></span>}
                    ...
                    <div class="destination">
                      {extraRestaurantImage[index] && (
                        <div>
                          <div class="icon d-flex justify-content-center align-items-center" onClick={() => handleDetailRestaurant(item.restaurant_id)}>
                            <img src={`http://localhost:5158/${extraRestaurantImage[index][0]}`} />
                      ...
                      <div class="text p-3">
                        ...
                        <p class="bottom-area d-flex">
                          ...
                          <span class="ml-auto">
                            {/* Booking */}
                            <Link onClick={() => increaseCartQuantity(item.restaurant_id, "Restaurant")}>Book Now</Link>
                          </span>
                        </p>
                      </div>
                    </div>
